...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `
            <div class="card h-100" id="back-color">
                <div class="p-3">
                ...
                <h5 id="text-color">Price: $ ${product.price}</h5>
                ...
                <div class="card-footer text-center">
                  <div class="d-flex flex-column flex-md-row justify-content-between">
                    <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="btn btn-outline-danger fw-bold">Add to cart</button>
                    <button id="details-btn" class="btn btn-outline-warning fw-bold">See Details</button>
                  </div>
                </div>
            </div>     
        `;
